...
const navLinks = [
  { name: "Home", href: "/", icon: FiHome },
  {
    ...
    icon: FiShoppingBag,
    dropdown: [
      { name: "জামদানি", href: "/shop?category=jamdani" },
      { name: "কাতান", href: "/shop?category=katan" },
      { name: "কটন", href: "/shop?category=cotton" },
      { name: "জাপানি সিল্ক", href: "/shop?category=japanese-silk" },
    ],
  },
